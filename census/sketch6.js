...
function writePopulationLabels(){
  ...
  var x = 450+(r+10)*cos(25*PI/20);
  var y = 290+(r+10)*sin(25*PI/20);
  text("0%",x,y);

  var x = 450+(r+10)*cos(27.5*PI/20);
  var y = 290+(r+10)*sin(27.5*PI/20);
  text("25%",x,y);

  var x = 450+(r+10)*cos(30*PI/20);
  var y = 290+(r+10)*sin(30*PI/20);
  text("50%",x,y);

  var x = 450+(r+10)*cos(32.5*PI/20);
  var y = 290+(r+10)*sin(32.5*PI/20);
  text("75%",x,y);
...
function writeEarningsLabels(){
  ...
  var x = 450+(r+5)*cos(5*PI/20);
  var y = 315+(r+5)*sin(5*PI/20);
  text(">$100,000",x,y);

  var x = 450+(r+5)*cos(7.5*PI/20);
  var y = 315+(r+5)*sin(7.5*PI/20);
  text("$75,000",x,y);

  textAlign(CENTER);

  x = 450+(r+5)*cos(10*PI/20);
  y = 315+(r+5)*sin(10*PI/20);
  text("$50,000",x,y);

  textAlign(RIGHT);

  x = 450+(r+5)*cos(12.5*PI/20);
  y = 315+(r+5)*sin(12.5*PI/20);
  text("$25,000",x,y);

  x = 450+(r+5)*cos(15*PI/20);
  y = 315+(r+5)*sin(15*PI/20);
  text("$0,000",x,y);
}
function writeTitle(){
  noStroke();
...
function mousePressed(){
  ...
  var dG = dist(mouseX,mouseY,790,40);
  var dB = dist(mouseX,mouseY,840,40);
...
function drawLabels(){
  ...
  noStroke();
  fill(244,65,239);
  ellipse(790,40,30,30);
  fill(70,88,237);
  ellipse(840,40,30,30);
